		    ...
		    <div class="modal-dialog">
		        <div class="modal-content">
		            <div class="modal-header">
		                ...
		                <h4 class="modal-title" id="myModalLabel">新增俱乐部玩家</h4>
		            </div>
		            <div class="modal-body">
		            		<input type="hidden" id="hiddenPkId">
		            		<div class="row"> 
			            		<div class="col-xs-3">
									<span>俱乐部ID</span>
								</div>
								<div class="col-xs-4">
									<input size="16" type="text" id="editClubId">
								</div>
							</div>
							<div class="row"> 
			            		<div class="col-xs-3">
		            ...
		            <div class="modal-footer">
		                ...
		                <button type="button" class="btn btn-primary" id="modifyClubMember">确定</button>
		            </div>
		        </div><!-- /.modal-content -->
		    </div><!-- /.modal -->
	<script type="text/javascript" src="/resources/js/wechat/clubMembers.js?version=${version}"></script>
  </body>
</html>
